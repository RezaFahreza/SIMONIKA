@extends('layouts.templateDepartemen', ['title' => 'Dashboard'])
            ...
            <div class="container px-4 py-5">
                ...
                <div class="card py-2">
                    <div class="row gy-2 ml-4 align-items-center">
                        <div class="col-1.5">
                            <img class="h-20 w-20 rounded-circle bg-gray-50 ml-4" src="{{ URL::asset('images/image2.png') }}" alt="foto profile">
                        </div>
                        <div class="card ml-4">
                            <div class="col md:text-justify">
                                <p class="text-sm font-weight-bold text-gray-900">Departemen</p>
                                <p class="mt-1 text-xs text-gray-500">Nama :{{$departemen->nama_departemen}}</p>
                                <p class="mt-1 text-xs text-gray-500">NIP :{{$departemen->kode_departemen}}</p>
                                <p class="mt-1 text-xs text-gray-500">Email :{{$departemen->email}}</p>
