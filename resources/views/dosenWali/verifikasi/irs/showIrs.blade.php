                        ...
                        <div class="container">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('dosenWali.verifikasi.irs.validate', ['id' => $irs->id]) }}" , method="POST">
                                        @csrf
                                        @method('PUT')
                                        <a href="{{ route('dosenWali.verifikasi.irs.edit', ['id' => $irs->id]) }}" class="btn btn-warning">Edit Entri</a>
