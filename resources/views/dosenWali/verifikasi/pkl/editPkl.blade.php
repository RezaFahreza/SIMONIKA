@extends('layouts.templateDosenWali', ['title' => 'Edit PKL'])
            ...
            <div class="container px-4 py-5 mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('dosenWali.verifikasi.pkl.update', ['id' => $pkl->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <a href="{{ route('dosenWali.verifikasi.pkl.show', ['id' => $pkl->id]) }}" class="btn btn-danger">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
