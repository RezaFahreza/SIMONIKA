@extends('layouts.templateDosenWali', ['title' => 'Edit Skripsi'])
            ...
            <div class="container px-4 py-5 mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('dosenWali.verifikasi.skripsi.update', ['id' => $skripsi->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <a href="{{ route('dosenWali.verifikasi.skripsi.show', ['id' => $skripsi->id]) }}" class="btn btn-danger">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
