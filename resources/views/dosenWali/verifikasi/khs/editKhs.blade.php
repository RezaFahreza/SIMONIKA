                ...
                <div class="container">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('dosenWali.verifikasi.khs.update', ['id' => $khs->id]) }}" method="post"
                                ...
                                <a href="{{ route('dosenWali.verifikasi.khs.show', ['id' => $khs->id, 'mahasiswa_id' => $khs->mahasiswa_id]) }}"
