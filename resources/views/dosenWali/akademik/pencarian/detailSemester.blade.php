@extends('layouts.templateDosenWali', ['title' => 'Detail Semester'])
    ...
    <main class="container">
        <div class="mx-auto py-6 sm:px-6 lg:px-8">
            <div class="mt-5">
                <div class="card p-4 ">
                    <div class="container">
                        <h2 class="text-center mb-3 font-semibold">Progress Perkembangan Studi Mahasiswa Perwalian</h2>
                        <div class="card">
                            <div class="card-body">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="md:flex md:items-center">
                                        <img src="{{ URL::asset('storage/' . $mahasiswa->foto_mahasiswa) }}"
                                            alt="Foto Mahasiswa" class="w-full md:w-2/3 mx-auto md:mx-0">
                                    </div>
                                    <div class="md:flex md:items-center">
                                ...
                                <div class="container">
                                    <div class="flex justify-between flex-wrap">
                                        ...
                                        @if (isset($irsMahasiswa[0]) && isset($khsMahasiswa[0]))
                                            <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 1]) }}"
                                                type="button"
                                        ...
                                        @if (isset($irsMahasiswa[1]) && isset($khsMahasiswa[1]))
                                            <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 2]) }}"
                                                type="button"
                                        ...
                                        @if (isset($irsMahasiswa[2]) && isset($khsMahasiswa[2]))
                                            <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 3]) }}"
                                                type="button"
                                        ...
                                        @if (isset($irsMahasiswa[3]) && isset($khsMahasiswa[3]))
                                            <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 4]) }}"
                                                type="button"
                                        ...
                                        @if (isset($irsMahasiswa[4]) && isset($khsMahasiswa[4]))
                                            <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 5]) }}"
                                                type="button"
                                        ...
                                        @if (isset($irsMahasiswa[5]) && isset($khsMahasiswa[5]))
                                            @if (isset($pkl))
                                                <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 6]) }}"
                                                    type="button"
                                        ...
                                        @if (isset($irsMahasiswa[6]) && isset($khsMahasiswa[6]))
                                            @if (isset($pkl) && $pkl->semester == '7')
                                                <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 7]) }}"
                                                    type="button"
                                        ...
                                        @if (isset($irsMahasiswa[7]) && isset($khsMahasiswa[7]))
                                            @if (isset($pkl) && $pkl->semester == '8')
                                                <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 8]) }}"
                                                    type="button"
                                        ...
                                        @if (isset($irsMahasiswa[8]) && isset($khsMahasiswa[8]))
                                            @if (isset($pkl) && $pkl->semester == '9')
                                                <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 9]) }}"
                                                    type="button"
                                        ...
                                        @if (isset($irsMahasiswa[9]) && isset($khsMahasiswa[9]))
                                            @if (isset($pkl) && $pkl->semester == '10')
                                                <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 10]) }}"
                                                    type="button"
                                        ...
                                        @if (isset($irsMahasiswa[10]) && isset($khsMahasiswa[10]))
                                            @if (isset($pkl) && $pkl->semester == '11')
                                                <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 11]) }}"
                                                    type="button"
                                        ...
                                        @if (isset($irsMahasiswa[11]) && isset($khsMahasiswa[11]))
                                            @if (isset($pkl) && $pkl->semester == '12')
                                                <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 12]) }}"
                                                    type="button"
                                        ...
                                        @if (isset($irsMahasiswa[12]) && isset($khsMahasiswa[12]))
                                            @if (isset($pkl) && $pkl->semester == '13')
                                                <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 13]) }}"
                                                    type="button"
                                        ...
                                        @if (isset($irsMahasiswa[13]) && isset($khsMahasiswa[13]))
                                            @if (isset($pkl) && $pkl->semester == '14')
                                                <a href="{{ route('dosenWali.akademik.profile.show.irs', ['nim' => $mahasiswa->nim, 'semester' => 14]) }}"
                                                    type="button"
                    ...
                    <div class="container mt-3">
                        ...
                        <a href="{{ route('dosenWali.akademik.index')}}" type="button"
