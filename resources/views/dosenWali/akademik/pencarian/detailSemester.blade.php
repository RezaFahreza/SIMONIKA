...
@extends('dosenwali.akademik.pencarian.detailIrsMahasiswa')
@extends('dosenwali.akademik.pencarian.detailKhsMahasiswa')
@extends('dosenwali.akademik.pencarian.detailPklMahasiswa')
@extends('dosenwali.akademik.pencarian.detailSkripsiMahasiswa')
