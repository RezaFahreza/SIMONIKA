                    ...
                    <div class="row gy-2 ml-4 align-items-center">
                        ...
                        <div class="card ml-4">
                            <div class="col md:text-justify">
                                ...
                                <p class="mt-1 text-xs text-gray-500">Nama :{{$dosenWali->nama}}</p>
                                <p class="mt-1 text-xs text-gray-500">NIP :{{$dosenWali->nip}}</p>
                                <p class="mt-1 text-xs text-gray-500">Email :{{$dosenWali->email}}</p>
