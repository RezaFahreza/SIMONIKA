                    ...
                    <div class="card">
                        <div class="container mt-4">
                            ...
                            <div class="flex-container">
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:steelblue">1</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:steelblue">2</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:steelblue">3</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:steelblue">4</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:steelblue">5</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:gold">6</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:steelblue">7</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:green">8</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:red">9</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:red">10</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:red">11</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:red">12</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:red">13</a>
                                <a href="#" data-toggle="modal" data-target="#progressModal" class="flex-item" style="background-color:red">14</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="progressModalLabel">Progress Studi Mahasiswa</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <!-- Isi modal di sini, misalnya informasi progress studi -->
