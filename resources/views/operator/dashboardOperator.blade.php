@extends('layouts.templateOperator')
            ...
            <div class="card px-4 py-2">
                <div class="row gx-4 gy-2 align-items-center">
                    ...
                    <div class="col ml-4">
                        ...
                        <p class="text-sm font-semibold text-gray-900">{{ $operator->nama }}</p>
                        <p class="mt-1 text-xs text-gray-500">{{ $operator->nip }}</p>
                        <p class="mt-1 text-xs text-gray-500">{{ $operator->email }}</p>
                    </div>
                </div>
            </div>
